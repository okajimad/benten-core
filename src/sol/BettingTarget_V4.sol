...
contract BettingTarget_V4   	is BentenContractBase {
    string private OutputFile = "BettingTarget_V4.sol";
    ICoinCashier internal _cashier;
    IRegulation internal _regulation;
    
    function betBody(address sender, bytes4 content, uint coin) internal;
    ...
    function bet(address sender, bytes4 content, uint coin) public {
