...
*/
contract GameBase_V8_R4    	is BettingTarget_V8, IGame {   
    string private OutputFile = "games\GameBase_V8_R4.sol";
    ...
    event Entried(address indexed user, bytes8 content, uint volume);
    ...
    function setDescription(bytes8 content, string new_description) public  {
    ...
    function setDescription_Multiple(bytes8 content1, string new_description1, bytes8 content2, string new_description2, bytes8 content3, string new_description3, bytes8 content4, string new_description4, bytes8 content5, string new_description5) public  {
    ...
    function getDescription(bytes8 content) public view returns(string) {
        for(uint i=0; i<_descriptions.length; i++) {
            CandidateDescription storage e = _descriptions[i];
            if(e.content == content) {
