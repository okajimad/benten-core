...
contract GenericSport_VariableOddsGame is VariableOddsGame_V4_R4 {
  constructor(string title, address cashier, address voting, address regulation, address owner, uint open_time, uint close_time, bool allow_cancel) public VariableOddsGame_V4_R4(title, cashier, voting, regulation, owner, open_time, close_time, allow_cancel) {
